...
namespace Tudor_Coborzan_Lab5_M
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\Tudor\Downloads\RESTAURANTSCORES.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=22,MinimumExampleCountPerLeaf=10,NumberOfTrees=8,MaximumBinCountPerFeature=139,FeatureFraction=0.9418195040406377,LearningRate=0.9999997766729865,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"RiskCategory"))      
